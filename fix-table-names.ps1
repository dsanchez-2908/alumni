# Script para convertir nombres de tablas a MAYÚSCULAS
# Preserva codificación UTF-8
...
Write-Host "Total de archivos a procesar: $($files.Count)" -ForegroundColor Cyan
Write-Host ""
...
foreach ($file in $files) {
    ...
    foreach ($table in $tableNames) {
        ...
        # Contar cuántas veces aparece la tabla en minúsculas
